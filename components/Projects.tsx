...
const Projects = () => {
  const projectData = [
    ...
    {
      title: "Sidekick",
      description: "A clean landing page template you can use for your side projects.",
    ...
    {
      title: "Sketch Sync",
      description: " Powerful rich text editor for structured note-taking, paired with a dynamic canvas to sketch ideas and bring concepts to life.",
      videoSrc: "/videos/sketch-sync.mp4",
