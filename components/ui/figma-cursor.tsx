...
export const FigmaCursor = () => {
    ...
    return (
            ...
            <AnimatePresence mode="wait">
                {isPointer ? (
                    <motion.div
                        ...
                        className="relative -ml-[15px] -mt-[8px]"
                    >
		...
		c-0.2-0.3-0.5-0.3-0.7,0c-0.2,0.4-0.7,1.1-1.1,1.1c-0.7,0.1-2.1,0-3.1,0c0,0,0.2-1-0.2-1.4c-0.3-0.3-0.8-0.8-1.1-1.1L11.3,20.4z"/>
                                ...
                                <path clip-path="url(#SVGID_2_)" fill="none" stroke="#000000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" d="
		...
		c-0.7,0.1-2.1,0-3.1,0c0,0,0.2-1-0.2-1.4c-0.3-0.3-0.8-0.8-1.1-1.1L11.3,20.4z"/>
                    ...
                    <motion.div
                        key="arrow"
                        initial={{ scale: 0.8, opacity: 0 }}
                        animate={{ scale: clicked ? 0.8 : 1, opacity: 1 }}
                        exit={{ scale: 0.8, opacity: 0 }}
                        transition={{ duration: 0.15 }}
                        className="relative -ml-[3px] -mt-[3px]"
                    >
